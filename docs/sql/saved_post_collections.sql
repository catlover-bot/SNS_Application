-- Saved posts / collections (bookmark)
...
-- Note:
-- Save count / bookmark count UI can be derived from public.reactions(kind='save')
-- while per-user collection assignment is stored in this table.
